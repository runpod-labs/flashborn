...
const CONCEPTS: Concept[] = [
  ...
  },
  {
    ...
    index: "02",
    name: "Terminal",
    tagline: "Phosphor-green CRT",
    note: "Monospace hacker terminal, ASCII frames, flicker, inverse-video nav.",
    accent: "#00FF66",
    ink: "#030503",
    bg: "linear-gradient(135deg,#020402,#04130a)",
    swatches: ["#00FF66", "#00B347", "#073B1E", "#030503"],
  },
  {
    slug: "foundry",
    index: "03",
